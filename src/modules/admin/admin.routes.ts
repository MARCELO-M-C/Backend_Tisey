...
const SINGLE_KEY_ENTITIES: EntityConfig[] = [
  ...
  },
  {
    ...
    delegate: "stay",
    idField: "id",
    bigintFields: ["cabinId", "primaryGuestId", "groupId", "createdBy"],
    blockedCreateFields: ["id", "createdAt"],
    blockedUpdateFields: ["id", "createdAt"],
  },
  {
    ...
    delegate: "order",
    idField: "id",
    bigintFields: ["tableId", "stayId", "stayGroupId", "createdBy", "waiterId", "shiftId"],
    blockedCreateFields: ["id", "createdAt"],
    blockedUpdateFields: ["id", "createdAt"],
  },
  {
  ...
  },
  {
    ...
    delegate: "invoice",
    idField: "id",
    bigintFields: ["issuedBy", "orderId", "stayId", "stayGroupId", "printedBy"],
